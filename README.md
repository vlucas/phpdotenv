...
Using Dotenv, you can require specific ENV vars to be defined ($_ENV, $_SERVER or getenv()). It does not check the existance in a '.env' file. Throw an exception if these ENV vars are not. This is particularly useful to let people know
